...
const IncomeCategory = () => {
  ...
  const dummyData = [
    { id: 1, idNo: '1', name: 'LOON PAID', createdAt: '30 Apr 2024' },
    { id: 2, idNo: '2', name: 'TAGADA', createdAt: '22 Apr 2024' },
    { id: 3, idNo: '3', name: 'LOON NEYA', createdAt: '22 Apr 2024' },
    { id: 4, idNo: '4', name: 'HALKHATA', createdAt: '22 Apr 2024' },
    { id: 5, idNo: '5', name: 'BAKI ADAY', createdAt: '22 Apr 2024' },
    { id: 6, idNo: '6', name: 'CASH SELL', createdAt: '17 Feb 2024' },
  ];
    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card" style={{ background: 'white', borderRadius: '8px', boxShadow: '0 2px 10px rgba(0,0,0,0.05)', overflow: 'hidden' }}>
        ...
        <div style={{ padding: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e2e8f0' }}>
          <h2 style={{ fontSize: '18px', fontWeight: 'bold', margin: '0', color: 'var(--text-main)' }}>Receive Category List</h2>
