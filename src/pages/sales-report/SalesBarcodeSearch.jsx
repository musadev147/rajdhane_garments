...
const SalesBarcodeSearch = () => {
  ...
  const dummyData = [
    { sl: 1, date: '25 Apr 2024', voucher: '25', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'S VOIL 70', barcode: '12', unit: 'GOZ', qty: 5, price: '68.00', total: '340', receive: '', due: '', profit: '70.00' },
    { sl: 2, date: '25 Apr 2024', voucher: '26', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'THREE PIECE', barcode: '355', unit: 'PEACE', qty: 1, price: '1590.00', total: '1590', receive: '', due: '', profit: '340.00' },
    { sl: 3, date: '25 Apr 2024', voucher: '27', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'BORKA', barcode: '254', unit: 'PEACE', qty: 1, price: '1250.00', total: '1250', receive: '', due: '', profit: '250.00' },
    { sl: 4, date: '25 Apr 2024', voucher: '28', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'DIGITAL CHUMKI 250', barcode: '104', unit: 'GOZ', qty: 2, price: '250.00', total: '500', receive: '', due: '', profit: '180.00' },
    { sl: 5, date: '25 Apr 2024', voucher: '29', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'JTLC N S R BORKHA', barcode: '249', unit: 'PEACE', qty: 1, price: '1300.00', total: '1300', receive: '', due: '', profit: '300.00' },
    { sl: 6, date: '25 Apr 2024', voucher: '30', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'ORBIT PRINT 90', barcode: '17', unit: 'GOZ', qty: 2, price: '90.00', total: '180', receive: '', due: '', profit: '30.00' },
    { sl: 7, date: '25 Apr 2024', voucher: '31', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'CHARI JORJET 180', barcode: '33', unit: 'GOZ', qty: 6, price: '200.00', total: '1200', receive: '', due: '', profit: '270.00' },
    { sl: 8, date: '25 Apr 2024', voucher: '32', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'DP INDIA SHIRT', barcode: '492', unit: 'PEACE', qty: 1, price: '1700.00', total: '1700', receive: '', due: '', profit: '850.00' },
    { sl: 9, date: '25 Apr 2024', voucher: '32', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'PANJABI', barcode: '115', unit: 'PEACE', qty: 1, price: '2000.00', total: '2000', receive: '', due: '', profit: '850.00' },
    { sl: 10, date: '25 Apr 2024', voucher: '88', client: 'RANIG CUSTOMER 2024 | 01 | ALL', product: 'DP INDIA SHIRT', barcode: '492', unit: 'PEACE', qty: 1, price: '1700.00', total: '1700', receive: '', due: '', profit: '1350.00' },
  ];
      ...
      <div className="premium-card">
        ...
        <PrintHeader />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '16px' }}>
            ...
            <div>
              <label style={{ display: 'block', fontSize: '13px', color: 'var(--label-color)', marginBottom: '8px', textAlign: 'center', background: '#38bdf8', color: 'white', width: 'fit-content', margin: '0 auto 8px auto', padding: '2px 8px', borderRadius: '12px' }}>Barcode</label>
            ...
            <table className="custom-table" style={{ width: '100%', fontSize: '11px', textAlign: 'center' }}>
              ...
              <tbody>
                ...
                <tr style={{ fontWeight: 'bold' }}>
                  ...
                  <td style={{ padding: '12px' }}>10148.00</td>
                  <td style={{ padding: '12px' }}>11650.00</td>
                  <td style={{ padding: '12px' }}>0.00</td>
                  <td style={{ padding: '12px' }}>0.00</td>
                  <td style={{ padding: '12px' }}>4490.00</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '16px' }}>
            <div style={{ fontSize: '13px', color: 'var(--text-muted)' }}>
              Showing 1 to 10 of 323,976 entries
            </div>
            <div style={{ display: 'flex' }}>
              ...
              <button style={{ padding: '6px 12px', border: '1px solid #e2e8f0', borderLeft: 'none', background: 'var(--card-header-bg)', color: 'var(--label-color)', cursor: 'pointer' }}>32398</button>
