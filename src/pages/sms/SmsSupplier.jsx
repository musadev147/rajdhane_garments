    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card">
        ...
        <div className="premium-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', background: 'white' }}>
          <h2 className="premium-title" style={{ fontSize: '14px', fontWeight: 'bold' }}>SEND SMS TO SUPPLIER</h2>
        ...
        <div className="premium-body" style={{ background: 'white', padding: '24px', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ width: '60%' }}>
            ...
            <div style={{ marginBottom: '40px' }}>
              <label style={{ display: 'block', fontSize: '12px', marginBottom: '8px', color: 'var(--text-muted)' }}>Supplier</label>
        ...
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.5)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000 }}>
          <div style={{ background: 'white', width: '800px', borderRadius: '8px', overflow: 'hidden', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)' }}>
            ...
            <div style={{ padding: '16px 24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid #e2e8f0' }}>
              <h3 style={{ fontSize: '16px', fontWeight: 'bold' }}>Add New Supplier</h3>
            ...
            <div style={{ padding: '24px' }}>
              <div className="form-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
                ...
                <div style={{ position: 'relative' }}>
                  <div style={{ position: 'absolute', top: '50%', left: '16px', transform: 'translateY(-50%)', color: 'var(--text-muted)' }}>🏦</div>
                  <input type="text" name="bankAccount" value={modalData.bankAccount} onChange={handleModalChange} placeholder=" " style={{ width: '100%', padding: '12px 12px 12px 40px', border: '1px solid #0ea5e9', borderRadius: '4px', outline: 'none' }} />
                ...
                <div style={{ display: 'flex' }}>
                  <div style={{ position: 'relative', flex: 1 }}>
                    <div style={{ position: 'absolute', top: '50%', left: '16px', transform: 'translateY(-50%)', color: 'var(--text-muted)', pointerEvents: 'none' }}>📚</div>
                    <select name="group" value={modalData.group} onChange={handleModalChange} style={{ width: '100%', padding: '12px 12px 12px 40px', border: '1px solid #0ea5e9', borderRight: 'none', borderRadius: '4px 0 0 4px', outline: 'none', appearance: 'none', color: 'var(--text-muted)' }}>
