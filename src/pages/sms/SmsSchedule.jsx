...
const SmsSchedule = () => {
  ...
  const [date, setDate] = useState('25/08/2026');
    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card">
        ...
        <div className="premium-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '16px 24px', background: 'white' }}>
          <h2 className="premium-title" style={{ fontSize: '14px', fontWeight: 'bold' }}>SEND SMS SCHEDULE WISE</h2>
          ...
          <div style={{ width: '60%' }}>
            ...
            <div style={{ marginBottom: '24px', position: 'relative' }}>
              ...
              <input 
                ...
                style={{ width: '100%', padding: '12px', border: '1px solid #0ea5e9', borderRadius: '4px', outline: 'none', color: 'var(--text-muted)' }} 
              />
            </div>
