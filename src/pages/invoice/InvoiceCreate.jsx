          ...
          <form>
            ...
            <div className="form-grid" style={{ gridTemplateColumns: '1fr 1fr', gap: '20px', marginBottom: '24px' }}>
              <div className="form-group" style={{ marginBottom: '0' }}>
                <div style={{ display: 'flex', border: '1px solid #e2e8f0', borderRadius: '4px', overflow: 'hidden' }}>
                  <div style={{ padding: '12px', background: 'var(--card-header-bg)', borderRight: '1px solid #e2e8f0', display: 'flex', alignItems: 'center' }}>
                    <Barcode size={24} style={{ color: 'var(--text-muted)' }} />
                  </div>
                  <input type="text" placeholder=" " style={{ flex: 1, padding: '12px', border: 'none', outline: 'none', color: '#94a3b8' }} />
            ...
            <div style={{ border: '1px solid #e2e8f0', marginBottom: '16px' }}>
              <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px' }}>
                ...
                <tbody>
                  {/* Empty state implicitly handled by empty tbody */}
                </tbody>
              </table>
            </div>
