...
const DepositCustomerWise = () => {
  ...
  const dummyData = [
    { sl: 1, date: '25 Aug 2026', idNo: '182630', client: 'Name: C.CASTOMER | Number: 01', invoiceId: '160524', desc: '', amount: '380.00', type: 'Invoice', category: 'CASH SELL' },
    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card">
        ...
        <div style={{ padding: '0', background: 'white', textAlign: 'center', borderBottom: '1px solid #e2e8f0' }}>
          ...
          />
          <h2 style={{ fontSize: '18px', fontWeight: 'bold', padding: '16px 0', margin: '0' }}>Customer Wise Deposit Report</h2>
        </div>
