    ...
    <div className="dashboard-content" style={{ paddingBottom: '100px' }}>
      ...
      <div className="premium-card">
        ...
        <div style={{ padding: '0', background: 'white', textAlign: 'center', borderBottom: '1px solid #e2e8f0' }}>
          ...
          />
          {/* Using Client Due Report title as per screenshot */}
        ...
        <PrintHeader />
          ...
          <div style={{ display: 'flex', justifyContent: 'center', gap: '24px', alignItems: 'flex-end', marginBottom: '24px' }}>
            <div style={{ width: '300px' }}>
              <label style={{ display: 'block', fontSize: '13px', color: 'var(--label-color)', marginBottom: '8px', textAlign: 'center' }}>Search By Client Group</label>
